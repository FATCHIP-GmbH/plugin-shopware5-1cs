...
$.plugin("fatchipFCSCCBrandDetect", {
    defaults: {
                    ...
                    for (var i = 0; i < me.opts.brands.length; i++) {
                        ...
                        if (typeof regExp !== 'undefined') {
                            ...
                            if (regExp.test(me.$el.val())) {
                                $("#payment_logo_fatchip_firstcash_creditcard").remove();
                                ...
                                $("<div>", {
                                    "id": "payment_logo_fatchip_firstcash_creditcard",
                                    "class": 'payment_logo_fatchip_firstcash_creditcard_' + me.opts.brands[i]
                                }).insertAfter(me.$el);
                                $("#fatchipfcsunsupported--message").remove();
                                $("#fatchipfcsinactive--message").remove();
...
$(".firstcash-brand-detect").fatchipFCSCCBrandDetect();
