            ...
            <div class="panel--body is--wide">
                ...
                {block name="frontend_checkout_payment_fatchip_firstcash_creditcard_cardnumber_input"}
                    <input name="CCNr" type="text"
                           id="CCNr"
                           class="payment--field is--required{if $error_flags.fatchip_firstcash__creditcard_cardnumber} has--error{/if}{if $creditCardSilentModeBrandDetection == 1} firstcash-brand-detect{/if}"
                           ...
                           data-CCNRErrorMessage="{s name='CreditcardNrErrorMessage' namespace='frontend/FatchipFCSPayment/translations'}Dieses Feld darf nur Ziffern enthalten{/s}"
                           data-unsupportedMessage="{s name='CreditcardNrUnsupportedMessage' namespace='frontend/FatchipFCSPayment/translations'}Dieser Kartentyp wird nicht unterstützt!{/s}"
                           data-inactiveMessage="{s name='CreditcardNrInactiveMessage' namespace='frontend/FatchipFCSPayment/translations'}Dieser Kartentyp wird nicht vom Händler akzeptiert!{/s}"
