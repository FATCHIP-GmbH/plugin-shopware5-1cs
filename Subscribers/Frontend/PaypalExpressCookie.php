...
class PaypalExpressCookie extends AbstractSubscriber
{
    ...
    {
        return [
            'CookieCollector_Collect_Cookies' => 'registerFCSPaypalExpressCookie'
        ];
    }
     ...
     */
    public function registerFCSPaypalExpressCookie()
    {
        if(class_exists('Shopware\\Bundle\\CookieBundle\\CookieCollection')) {
            ...
            /** @var Payment $payment */
            $payment = $paymentRepository->findOneBy(['name' => 'fatchip_firstcash_paypal_express']);
            ...
            $collection->add(new CookieStruct(
                ...
                'Firstcash Paypal Express Cookies',
