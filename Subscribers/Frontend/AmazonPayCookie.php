...
class AmazonPayCookie extends AbstractSubscriber
{
    ...
    {
        return [
            'CookieCollector_Collect_Cookies' => 'registerFCSAmazonCookie'
        ];
    }
     ...
     */
    public function registerFCSAmazonCookie()
    {
        if(class_exists('Shopware\\Bundle\\CookieBundle\\CookieCollection')) {
            ...
            /** @var Payment $payment */
            $payment = $paymentRepository->findOneBy(['name' => 'fatchip_firstcash_amazonpay']);
